...
public class MainActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(MainActivityAdmin.this, 1);
        ...
        adapter = new MyAdapter(MainActivityAdmin.this, dataList);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityAdmin.this, UploadActivityAdmin.class);
        ...
        adapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(MainActivityAdmin.this, DetailActivityAdmin.class);
